      ...
      <div class="py-6 bg-slate-600 flex justify-center items-center w-full block 2xl:hidden">
          <ul class="flex justify-center items-center">
            <li><a href="http://" target="_blank">
              <img src="<?php echo get_site_url(); ?>/assets/images/icons/facebook.png" alt="facebook" class="mx-2 h-14 hover:opacity-80">
            </a></li>
            <li><a href="http://" target="_blank">
              <img src="<?php echo get_site_url(); ?>/assets/images/icons/twitter.png" alt="twitter" class="mx-2 h-14 hover:opacity-80">
            </a></li>
            <li><a href="http://" target="_blank">
              <img src="<?php echo get_site_url(); ?>/assets/images/icons/youtube.png" alt="youtube" class="mx-2 h-14 hover:opacity-80">
            </a></li>
            <li><a href="http://" target="_blank">
              <img src="<?php echo get_site_url(); ?>/assets/images/icons/instagram.png" alt="instagram" class="mx-2 h-14 hover:opacity-80">
            </a></li>
          </ul>
      </div>
    ...
    <section>
      <div id="cookie-notice" class="fixed bottom-0 left-0 w-full p-4 bg-white text-center" style="display: none;">
        ...
        <button id="accept-cookies" class="bg-emerald-300 hover:bg-emerald-200 ml-2 px-4 py-2 rounded">Accept</button>
      </div>
    </section>
    <script>
